...
export function FloatingWhatsApp({ phoneNumber }: { phoneNumber?: string }) {
  ...
  return (
    <m.a
      ...
      className="fixed bottom-24 md:bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition-transform hover:scale-110 hover:shadow-xl rtl:left-6 rtl:right-auto"
